...
SAVE_DIR="/data/run01/scw6f3q/zncao/affincraft-nn/ckpt_bn2"     # 检查点和日志保存目录 

# 【修改】LMDB 数据路径 (不再需要索引文件)
TRAIN_LMDB="/ssd/home/scw6f3q/bn2_high_train"
VALID_LMDB="/ssd/home/scw6f3q/bn_high_valid"

# --- 数据规模 (用于计算 update 数) ---
NUM_SAMPLES=220000              # 训练样本总数（你说的数据量）

# --- 核心训练参数 ---
LR=5e-5                         # 学习率
BATCH_SIZE_PER_GPU=7            # 单GPU批次大小
UPDATE_FREQ=1                   # 梯度累积步数
SEED=42                         # 随机种子
NUM_WORKERS=3                   # 每个GPU的DataLoader worker数量

# ====================================================================================
# 1. 根据 22 万数据 & 100 个 Epoch 重新计算总步数和预热步数
# ====================================================================================
